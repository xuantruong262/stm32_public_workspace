...
clean-FATFS:
	-$(RM) ./FATFS/diskio.d ./FATFS/diskio.o ./FATFS/diskio.su ./FATFS/ff.d ./FATFS/ff.o ./FATFS/ff.su ./FATFS/ffsystem.d ./FATFS/ffsystem.o ./FATFS/ffsystem.su ./FATFS/ffunicode.d ./FATFS/ffunicode.o ./FATFS/ffunicode.su ./FATFS/user_diskio_spi.d ./FATFS/user_diskio_spi.o ./FATFS/user_diskio_spi.su
