...
const unsigned char OV2640_QVGA[][2]={
		 {0xff, 0x00},  {0x2c, 0xff},  {0x2e, 0xdf},  {0xff, 0x01},  {0x3c, 0x32},  {0x11, 0x00},
		  ...
		  {0xdd, 0x7f},  {0x05, 0x00},  {0xff, 0x00},  {0xe0, 0x10},  {0xc0, 0xc8},
		  {0x53, 0x00},  {0x54, 0x00},  {0x55, 0x88},  {0x57, 0x00},  {0x5a, 0x50},
		  {0x5b, 0x39},  {0x5c, 0x00},  {0xd3, 0x08},  {0xe0, 0x00},  {0xFF, 0x00},
		  {0x05, 0x00},  {0xDA, 0x08},  {0xda, 0x10},  {0x98, 0x00},  {0x99, 0x00},
		  {0x00, 0x00}
};


//__attribute__((section(".RAM_D1"), aligned(4)))
unsigned char OV2640_JPEG_INIT[][2] = { { 0xff, 0x00 }, { 0x2c, 0xff }, {
...
////hardware and software init
	HAL_GPIO_WritePin(CAMERAPWDN_GPIO_Port, CAMERAPWDN_Pin, GPIO_PIN_RESET); //power on
	HAL_Delay(1);
