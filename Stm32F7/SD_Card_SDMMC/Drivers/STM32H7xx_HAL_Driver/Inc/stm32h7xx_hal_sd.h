...
/** @defgroup SD_Exported_Types_Group2 SD Card State enumeration structure
  * @{
  */
typedef uint32_t HAL_SD_Card_SDMMCStateTypeDef;

#define HAL_SD_Card_SDMMC_READY          0x00000001U  /*!< Card state is ready                     */
#define HAL_SD_Card_SDMMC_IDENTIFICATION 0x00000002U  /*!< Card is in identification state         */
#define HAL_SD_Card_SDMMC_STANDBY        0x00000003U  /*!< Card is in standby state                */
#define HAL_SD_Card_SDMMC_TRANSFER       0x00000004U  /*!< Card is in transfer state               */
#define HAL_SD_Card_SDMMC_SENDING        0x00000005U  /*!< Card is sending an operation            */
#define HAL_SD_Card_SDMMC_RECEIVING      0x00000006U  /*!< Card is receiving operation information */
#define HAL_SD_Card_SDMMC_PROGRAMMING    0x00000007U  /*!< Card is in programming state            */
#define HAL_SD_Card_SDMMC_DISCONNECTED   0x00000008U  /*!< Card is disconnected                    */
#define HAL_SD_Card_SDMMC_ERROR          0x000000FFU  /*!< Card response Error                     */
/**
  * @}
  */
...
#endif /* USE_HAL_SD_REGISTER_CALLBACKS */
{
  ...
  HAL_SD_Card_SDMMCInfoTypeDef       SdCard;           /*!< SD Card information                 */
...
} HAL_SD_Card_SDMMCStatusTypeDef;
/**
  * @}
  */
...
/** @defgroup SD_Exported_Functions_Group4 SD card related functions
  * @{
  */
HAL_SD_Card_SDMMCStateTypeDef HAL_SD_GetCardState(SD_HandleTypeDef *hsd);
HAL_StatusTypeDef       HAL_SD_GetCardCID(const SD_HandleTypeDef *hsd, HAL_SD_Card_SDMMCCIDTypeDef *pCID);
HAL_StatusTypeDef       HAL_SD_GetCardCSD(SD_HandleTypeDef *hsd, HAL_SD_Card_SDMMCCSDTypeDef *pCSD);
HAL_StatusTypeDef       HAL_SD_GetCardStatus(SD_HandleTypeDef *hsd, HAL_SD_Card_SDMMCStatusTypeDef *pStatus);
HAL_StatusTypeDef       HAL_SD_GetCardInfo(const SD_HandleTypeDef *hsd, HAL_SD_Card_SDMMCInfoTypeDef *pCardInfo);
/**
  * @}
  */
