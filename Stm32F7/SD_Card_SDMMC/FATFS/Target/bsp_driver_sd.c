...
{
  return ((HAL_SD_GetCardState(&hsd1) == HAL_SD_Card_SDMMC_TRANSFER ) ? SD_TRANSFER_OK : SD_TRANSFER_BUSY);
}

/**
  * @brief  Get SD information about specific SD card.
  * @param  CardInfo: Pointer to HAL_SD_Card_SDMMCInfoTypedef structure
  * @retval None
  */
__weak void BSP_SD_GetCardInfo(HAL_SD_Card_SDMMCInfoTypeDef *CardInfo)
{
